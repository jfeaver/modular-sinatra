...
modular_sinatra/
\u251c\u2500\u2500 config       # config files
\u251c\u2500\u2500 controllers  # controllers with routes
\u251c\u2500\u2500 lib          # back end ruby files
\u251c\u2500\u2500 log          # make sure you require 'logger' if you want to use log files
\u251c\u2500\u2500 public       # Stylesheets, images, etc.
\u2514\u2500\u2500 views        # Application layout in layout.haml
